    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-base text-secondary">navidrezaabbaszadeh89@gmail.com</p>
        </div>
      </div>
      {/* Dashboard Title & Subtitle */}
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
        <div className="title text-2xl">Dashboard</div>
        <span className="text-sm text-secondary mt-1">Your personal overview</span>
      </div>
      {/* Logo & Notifications */}
      <div className="flex items-center gap-6">
        ...
        <div className="relative cursor-pointer">
          ...
          <span className="absolute -top-1 -right-1 bg-primary text-white text-xs rounded-full px-1.5 py-0.5 border-2 border-background">3</span>
        </div>
      </div>
    </div>
  );
